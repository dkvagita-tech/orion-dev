...
async function main() {
  ...
  await prisma.siteSettings.upsert({
    ...
    create: {
      ...
      aiJourney: "Started exploring AI in 2023 through chatbots and automation. Now building AI-integrated portfolio tools, RAG assistants, and intelligent UX patterns using Gemini and modern web stacks.",
  ...
  const projects = [
    ...
    },
    {
      ...
      techStack: ["JavaScript", "Gemini", "CSS"],
      category: "ai",
      tags: ["ai", "nlp", "chatbot"],
  ...
  await prisma.blogPost.upsert({
    ...
    create: {
      ...
      content: "This post covers RAG patterns, Next.js API routes, and Gemini integration for portfolio sites...",
      category: "AI",
      tags: ["ai", "nextjs", "gemini"],
      status: "PUBLISHED",
      readTime: 6,
